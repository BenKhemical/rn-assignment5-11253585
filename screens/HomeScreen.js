...
import { useDarkMode } from '../components/DarkModeFeature';
      ...
      <ScrollView>
        <View style={styles.firstSection}>
          ...
          <View style={styles.textSection}>
            ...
            <Text style={styles.name}>Bernard Afful</Text>
          </View>
          <Ionicons style={styles.search} name="search" size={30} color={isDarkMode ? 'white' : 'grey'} />
        </View>

        <Image style={styles.card} source={require('../images/Card.png')} />
        ...
        <TransactionItem iconSource={require('../images/apple.png')} name="Apple Store" category="Entertainment" amount="-$12.00" />
        <TransactionItem iconSource={require('../images/sportify.png')} name="Spotify" category="music" amount="-$15.00" />
        <TransactionItem iconSource={require('../images/grocery.png')} name="Grocery" category="Purchase" amount="-$88.00" />
        <TransactionItem iconSource={require('../images/moneyTransfer.png')} name="Money Transfer" category="Transaction" amount="$300.00" />
      </ScrollView>
    </View>
  );
}
